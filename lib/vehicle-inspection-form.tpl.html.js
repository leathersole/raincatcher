...
ngModule.run(['$templateCache', function ($templateCache) {
  $templateCache.put('wfm-template/vehicle-inspection-form.tpl.html',
    ...
    '      <md-radio-button style="display: inline; margin: 5px" value="0%" aria-label="0%"></md-radio-button>\n' +
    '      <md-radio-button style="display: inline; margin: 5px" value="25%" aria-label="25%"></md-radio-button>\n' +
    '      <md-radio-button style="display: inline; margin: 5px" value="50%" aria-label="50%"></md-radio-button>\n' +
    '      <md-radio-button style="display: inline; margin: 5px" value="75%" aria-label="75%"></md-radio-button>\n' +
    '      <md-radio-button style="display: inline; margin: 5px" value="100%" aria-label="100%"></md-radio-button>\n' +
    '    </md-radio-group>\n' +
    '  </md-grid-tile>\n' +
    '\n' +
    '  <md-grid-tile md-rowspan="2">\n' +
