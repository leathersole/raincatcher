...
var WorkorderCloudDataTopics = require('fh-wfm-mediator/lib/topics');
var WorkorderCloudTopics = require('fh-wfm-mediator/lib/topics');

module.exports = function(mediator, app, mbaasApi) {
  //Used for cloud data storage topics
  var workorderCloudDataTopics = new WorkorderCloudDataTopics(mediator);
  workorderCloudDataTopics.prefix(config.cloudDataTopicPrefix).entity(config.datasetId);

  //Used for cloud topics
  var workorderCloudTopics = new WorkorderCloudTopics(mediator);
