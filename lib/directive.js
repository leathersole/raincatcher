...
ngModule.directive('schedule', function($templateCache, $timeout, mediator) {
  ...
  function renderWorkorder(hourElement, workorder) {
    hourElement.innerHTML = '<span class="wfm-chip wfm-chip-no-picture" style="width:300px"><span class="wfm-chip-name">'+workorder.type+' #'+workorder.id+'</span></span>';
  }

  function renderWorkorders(element, workorders) {
    ...
    _.forIn(workordersByWorker, function(workorders, workerId) {
      ...
      workorders.forEach(function(workorder) {
        ...
        if (hourElement) {
          renderWorkorder(hourElement, workorder);
        }
      });
    });
  }
  ...
  return {
    ...
    link: function (scope, element, attrs) {
      ...
      $timeout(function afterDigest() {
        renderWorkorders(element[0], scope.workorders);
        ...
        Array.prototype.forEach.call(droppables, function(droppable) {
          ...
          droppable.addEventListener('drop', function(e) {
            ...
            renderWorkorder(this, workorder)
