      ...
      $timeout(function afterDigest() {
        ...
        Array.prototype.forEach.call(droppables, function(droppable) {
          ...
          droppable.addEventListener('drop', function(e) {
            return drop.apply(this, [e, scope, dragged]);
          });
        });

        var unscheduledWorkorderList = element[0].querySelector('.wfm-scheduler-workorders');
        unscheduledWorkorderList.addEventListener('dragover', dragover);
        unscheduledWorkorderList.addEventListener('dragenter', dragenter);
        unscheduledWorkorderList.addEventListener('dragleave', dragleave);
        unscheduledWorkorderList.addEventListener('drop', function(e) {
          return drop.apply(this, [e, scope, dragged]);
        });
